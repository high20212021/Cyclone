...
class CrashDump{
	...
	private function encodeData(){
		...
		$this->encodedData = libdeflate_zlib_compress(json_encode($this->data, JSON_UNESCAPED_SLASHES), 9);
	...
	private function generalData(){
		...
		$this->addLine("Cyclone version: " . \pocketmine\GIT_COMMIT . " [Protocol " . Info::CURRENT_PROTOCOL . "; API " . API_VERSION . "]");
